# -*- coding: utf-8 -*-
"""
Anchor Sensitivity Ablation (2PL Bayesian IRT) — XSafety.
Adapted from irt_validations/anchor_sensitivity_ablation.py:
  - Uses XSafety_Dataset.csv (single pass)
  - ANCHOR_FILE from local model/xsafety/results_dif_stratified/
  - category_balanced uses 'category' column (single string, not tags list)
